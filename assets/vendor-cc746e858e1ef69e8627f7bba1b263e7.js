...
function n(e,t){let n=e.getBoundingClientRect().top
return n-t<=0?"top":n+e.offsetHeight+t<=window.innerHeight?"in":"bottom"}Object.defineProperty(e,"__esModule",{value:!0})
var r=Ember.computed.or,i=Ember.computed.notEmpty,o=Ember.String.htmlSafe,s=Ember.Component,a=Ember.computed,u=Ember.run.scheduleOnce
...
return r-e-t-n}),style:a("isSticky","ownHeight","ownWidth",function(){let e=this.get("ownHeight"),t=this.get("ownWidth")
if(e>0&&this.get("isSticky"))return o(`height: ${e}px; width: ${t}px`)}),containerStyle:a("isStickyTop","isStickyBottom","top","bottom",function(){if(this.get("isStickyBottom")){let e=`position: absolute; bottom: ${this.get("bottom")}px; width: ${this.get("ownWidth")}px`
return o(e)}if(this.get("isStickyTop")){let e=`position: fixed; top: ${this.get("top")}px; width: ${this.get("ownWidth")}px`
return o(e)}}),updateDimension(){this.set("windowHeight",window.innerHeight),this.set("ownHeight",this.element.offsetHeight),this.set("ownWidth",this.element.offsetWidth)},updatePosition(){let{topTriggerElement:e,bottomTriggerElement:t}=this
e&&this.set("parentTop",n(e,this.get("top"))),t&&this.set("parentBottom",n(t,this.get("offsetBottom")))},didInsertElement(){this._super(...arguments),u("afterRender",this,this.updateDimension)},actions:{parentTopEntered(){this.set("parentTop","in")},parentTopExited(){this.updateDimension(),this.updatePosition()},parentBottomEntered(){this.set("parentBottom","in")},parentBottomExited(){this.updatePosition()},registerTopTrigger(e){this.topTriggerElement=e,this.updatePosition()},registerBottomTrigger(e){this.bottomTriggerElement=e,this.updatePosition()}}})}),define("ember-sticky-element/components/sticky-element/trigger",["exports","ember-in-viewport"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
